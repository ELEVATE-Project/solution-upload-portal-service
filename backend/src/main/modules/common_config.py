host = "" #Please add the host here
internal_kong_ip = "" #Please add the internal_kong_ip here
keyclockapibody = "" #Please add the keyclockapibody here
authorization = "" #Please add the authorization here
authorizationforhost = "" #Please add the authorizationforhost here
appname = "diksha"
x_channel_id = "" #Please add the x_channel_id here
internal_access_token = "" #Please add the internal_access_token here
